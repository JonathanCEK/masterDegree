...
dados_componentes = [
    ...
    {"texto": "Botton app bar", "imagem_path": "imagem_1.png"},
    {"texto": "Top app bar", "imagem_path": "imagem_2.png"},
    {"texto": "Badges", "imagem_path": "imagem_bad.png"},
    {"texto": "Common buttons", "imagem_path": "imagem_6.png"},
    {"texto": "Floating Action Buttons", "imagem_path": "imagem_fab.png"},
    {"texto": "Extended FAB", "imagem_path": "imagem_exfab.png"},
    {"texto": "Icon Buttons", "imagem_path": "imagem_btt.png"},
    {"texto": "Segmented Buttons", "imagem_path": "imagem_seg.png"},
    {"texto": "Cards", "imagem_path": "imagem_8.png"},
    {"texto": "MultiCard", "imagem_path": "imagem_cards.png"},
    {"texto": "Carousel", "imagem_path": "imagem_car.png"},
    {"texto": "Checkbox", "imagem_path": "imagem_9.png"},
    {"texto": "Chips", "imagem_path": "imagem_10.png"},
    {"texto": "Date pickers", "imagem_path": "imagem_12.png"},
    {"texto": "Dialog", "imagem_path": "imagem_13.png"},
    {"texto": "Dialog full-screen", "imagem_path": "imagem_fls.png"},
    {"texto": "Divider", "imagem_path": "imagem_14.png"},
    {"texto": "Lists", "imagem_path": "imagem_16.png"},
    {"texto": "Menus", "imagem_path": "imagem_17.png"},
    {"texto": "Navigation bar", "imagem_path": "imagem_5.png"},
    {"texto": "Navigation drawer", "imagem_path": "imagem_18.png"},
    {"texto": "Navigation rail", "imagem_path": "imagem_19.png"},
    {"texto": "Progress indicators (horizontal)", "imagem_path": "imagem_20.png"},
    {"texto": "Progress indicators analogico", "imagem_path": "imagem_ana.png"},
    {"texto": "Radio button", "imagem_path": "imagem_21.png"},
    {"texto": "Search", "imagem_path": "imagem_ser.png"},
    {"texto": "Bottom sheets", "imagem_path": "imagem_22.png"},
    {"texto": "Side sheets", "imagem_path": "imagem_23.png"},
    {"texto": "Sliders", "imagem_path": "imagem_24.png"},
    {"texto": "Snackbar", "imagem_path": "imagem_25.png"},
    {"texto": "Switch", "imagem_path": "imagem_26.png"},
    {"texto": "Primary tabs", "imagem_path": "imagem_27.png"},
    {"texto": "Secondary tabs", "imagem_path": "imagem_sec.png"},
    {"texto": "Text field", "imagem_path": "imagem_28.png"},
    {"texto": "Time picker dial", "imagem_path": "imagem_dia.png"},
    {"texto": "Time picker input", "imagem_path": "imagem_29.png"},
    {"texto": "Tool tips", "imagem_path": "imagem_30.png"},
    {"texto": "Text View", "imagem_path": "imagem_.png"},
    {"texto": "Map View", "imagem_path": "imagem_map.png"},
    {"texto": "Web view", "imagem_path": "imagem_web.png"},
    {"texto": "Image View", "imagem_path": "imagem_im.png"},
    {"texto": "Video View", "imagem_path": "imagem_vid.png"},
    {"texto": "Noturno", "imagem_path": "imagem_.png"},
    {"texto": "Paisagem", "imagem_path": "imagem_pai.png"},
    {"texto": "Music", "imagem_path": "imagem_mus.png"},
    {"texto": "Sound Effects", "imagem_path": "imagem_sound.png"},
    {"texto": "Acccount", "imagem_path": "imagem_acc.png"},
